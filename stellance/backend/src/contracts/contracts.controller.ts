...
export class ContractsController {
  ...
  @Get()
  findAll(@Req() req: AuthRequest, @Query('as') as_?: 'client' | 'freelancer') {
  ...
  @ApiOperation({
    summary: 'Confirm escrow funded — submit Stellar tx hash (CLIENT)',
  })
  ...
  @ApiOperation({
    summary:
      'Client approves a milestone — triggers on-chain release_milestone()',
  })
